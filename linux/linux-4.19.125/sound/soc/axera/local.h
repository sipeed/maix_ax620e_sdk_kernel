...
#define RSLOT(x)			(0x4 * x + 0x224)
#define TSLOT(x)			(0x4 * x + 0x224)
...
struct dw_i2s_dev {
	...
	unsigned int tx_ptr;
	unsigned int rx_ptr;
	enum dw_intr_type intr_type;
	struct resource *pinmux_res;
	struct resource *pin_g3_res;
