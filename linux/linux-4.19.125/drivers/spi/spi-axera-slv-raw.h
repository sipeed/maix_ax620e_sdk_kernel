...
#define SPI_SLOVE_OFFSET		12
#define SPI_SLOVE_MASK			(1 << SPI_SLOVE_OFFSET)
#define SPI_SLOVE_ENABLE		0
#define SPI_SLOVE_DISABLE		1
...
extern void dw_ahb_spi_set_cs(struct spi_device *spi, bool enable);
extern int dw_ahb_spi_add_host(struct device *dev, struct dw_spi *dws);
extern void dw_ahb_spi_remove_host(struct dw_spi *dws);
extern int dw_ahb_spi_suspend_host(struct dw_spi *dws);
extern int dw_ahb_spi_resume_host(struct dw_spi *dws);

/* platform related setup */
extern int dw_spi_dma_register(struct dw_spi *dws);
